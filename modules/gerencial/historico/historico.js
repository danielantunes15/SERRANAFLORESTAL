...
// Envelopado em uma função anônima (IIFE) para isolar o escopo e 
// ELIMINAR para sempre o erro "Identifier has already been declared"
(function() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        // Usa a função do window para carregar
        if (typeof window.loadHistoricoCompleto === 'function') {
    ...
    // Exporta a função para o Window para o botão do HTML conseguir clicar nela
